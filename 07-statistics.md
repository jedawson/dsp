...
>> Pr(identical twins & twin brother)/Pr(twin brother) = (1/2*1/300)/((1/2*1/300)+(1/4*1/125)) = 5/11
...
>> The main difference is that the Bayesian statistics has a prior that may be subjectively determined. Frequentist statistics also only assign probability to events and not hypotheses. 
